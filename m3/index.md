...
| 🟢 Entra no mapa de oportunidades | 🔴 Fica de fora (por enquanto) |
|---|---|
| Processo recorrente da sua área com entrada e saída definidas | O maior processo da área — importante demais para ser piloto |
| Tarefa de compilar, cruzar, redigir ou sintetizar que consome hora de gestor | Oportunidade cujo insumo obrigatório é dado sensível sem versão desidentificada |
| Onde existe indicador hoje para medir antes e depois | Decisão sobre pessoa — avaliação, desligamento, promoção |
| O que você testa em 2 semanas sem aprovação de orçamento | O que exige integração de sistema ou compra — isso é projeto, não piloto |
...
|---|---|---|---|
| Nota sem justificativa | Tudo 5×5 e risco "baixo" — o ranking não discrimina nada | Pontuar por entusiasmo, não por evidência | 1 linha de justificativa por nota; sem justificativa, a nota desce 1 ponto |
| Ignorar a dimensão risco | Top-1 é a análise de contrato com dados reais — no primeiro dia | Impacto alto seduz; risco não aparece até dar errado | Risco alto não elimina — reposiciona: desidentifique, valide com o dono do dado, comece menor |
| Oportunidade órfã | "A área deveria usar IA em X" — mas ninguém do grupo executa X | Mapear o processo dos outros é mais fácil que o próprio | Regra do piloto: quem mapeia executa. Sem dono na mesa, sai do ranking |

---

> ⚠️ **Anti-alucinação — antes da dinâmica em grupo**
> - No exercício, **só dado fictício ou desidentificado** — troque valores, nomes e cláusulas reais por aproximações. O método não precisa do dado verdadeiro para ser validado.
> - Você responde pela área: o que o seu grupo cola no prompt hoje é decisão sua de governança — o M4 formaliza a régua.
> - A IA responde com confiança mesmo quando inventa — caso-âncora **Mata v. Avianca (2023)**. Em oportunidade que toca norma, contrato ou número: validação na fonte faz parte do processo, e entra no custo da nota de facilidade.
...
[← M2 · IA para Gestores](../m2/) · [M4 · Uso Responsável, Governança e Liderança da Adoção →](../m4/)
